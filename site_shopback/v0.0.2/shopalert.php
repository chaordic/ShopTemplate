...
$title = 'ShopAlert - '.TITLE2;
$description = '';
$class = 'page-shopalert';
?>
<!DOCTYPE html>
...
<body class="bg-header">
	...
	<main class="main">
		...
		<?php include(DIRPATHP.'/app/includes/modules/produtos/alert/header.php'); ?>
		<?php include(DIRPATHP.'/app/includes/modules/produtos/alert/solucoes.php'); ?>
		<?php include(DIRPATHP.'/app/includes/modules/produtos/alert/info.php'); ?>
