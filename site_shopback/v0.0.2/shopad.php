...
<body class="bg-header">
	...
	<main class="main">
		...
		<?php include(DIRPATHP.'/app/includes/modules/produtos/ad/header.php'); ?>
		<?php include(DIRPATHP.'/app/includes/modules/produtos/ad/funciona.php'); ?>
		<?php include(DIRPATHP.'/app/includes/modules/produtos/ad/info.php'); ?>
