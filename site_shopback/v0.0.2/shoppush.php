...
<body class="bg-header">
	...
	<main class="main">
		...
		<?php include(DIRPATHP.'/app/includes/modules/produtos/push/header.php'); ?>
		<?php include(DIRPATHP.'/app/includes/modules/produtos/push/funciona.php'); ?>
		<?php include(DIRPATHP.'/app/includes/modules/produtos/push/solucoes.php'); ?>
