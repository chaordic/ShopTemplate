...
$title = 'ShopConvert - '.TITLE2;
$description = '';
$class = 'page-shopconvert';
?>
<!DOCTYPE html>
...
<body class="bg-header">
	...
	<main class="main">
		...
		<?php include(DIRPATHP.'/app/includes/modules/produtos/convert/header.php'); ?>
		<?php include(DIRPATHP.'/app/includes/modules/produtos/convert/solucoes.php'); ?>
		<?php include(DIRPATHP.'/app/includes/modules/produtos/convert/info.php'); ?>
