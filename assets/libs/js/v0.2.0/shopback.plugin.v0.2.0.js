/*
	...
	* @author: Gabriel Lopes Gomes[gl@shopback.com.br], Mizael Silva Lemos [ms@shopback.com.br]
		...
		try {
			...
			$.ajax({
				...
				success: function(data) {
					...
					$(".thanks").show();
					$(".close").attr({
						onclick: 'top.spl.close(); top.spl.redirect();'
					});
				},
...
// \Bloco social -------------------------------------------------------------------------------------------------------------
	...
	SB.creatBox = function(object){
		...
		object.normal_price = (object.normal_price == object.price) ? "": object.normal_price;
